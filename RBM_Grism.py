...
# Creating architecture of RBM Neural Networks. Probablistic Graphical Model
class RBM():
    ...
    def sample_v (self, x):
        ...
        pvh = torch.sigmoid(activation)
        return pvh, torch.bernoulli(pvh)
